call cd ..
call python reportAnaliser.py -i EncodeDS/FS6/A/FS6FS__A_h_Mod1_isEmpty_Mod1_push.csv -ur Reports-ruleValidator/ruleValidator-FS1/* -r Rules/fs-1__sup_02-conf_1.csv -s directory -f finalReport -o fs-1.csv
